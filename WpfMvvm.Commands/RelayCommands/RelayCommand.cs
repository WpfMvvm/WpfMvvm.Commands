...
namespace WpfMvvm.Commands
{
    ...
    public class RelayCommand : IRelayCommand, ICommandRaise, ICommand
    {
        ...
        // Метод для делегата canExecuteObject для переданных методов без параметра.
        ...
        /// <summary>Ошибка возникающая при передаче в конструктор <see cref="RelayCommand"/> параметра executeHandler=<see langword="null"/>.</summary>
        public static ArgumentNullException ExecuteHandlerNullException = new ArgumentNullException("executeHandler");

        /// <summary>Ошибка возникающая при передаче в конструктор <see cref="RelayCommand"/> параметра canExecuteHandler=<see langword="null"/>.</summary>
        ...
        /// если передан тип не приводимый по шаблону к типу команды.</summary>
        ...
        /// <summary>Возникает в <see cref="Execute(object)"/>, 
        /// если в передан <see langword="null"/>, а тип <see cref="ParameterType"/> который не может принять <see langword="null"/>.</summary>
